...
class postController extends baseController{
    ...
    public function comment($args = false){
        ...
        public function ajaxGetDisLikeComments($args = false)
        {
            $registry = Registry::getInstance();	
            $model = $this->load->model('post');
            $args = $registry->args;
            ...
            $comm = $model->getDisLikeComments($args[0], $ar);
        ...
        public function ajaxGetLikeComments($args = false)
        {
            $registry = Registry::getInstance();	
            $model = $this->load->model('post');
            $args = $registry->args;
            ...
            $ar = isset($args[1]) ? $args[1] : TRUE;
            $ar = ($ar == "true") ? TRUE : FALSE;
            $comm = $model->getLikeComments($args[0], $ar);
